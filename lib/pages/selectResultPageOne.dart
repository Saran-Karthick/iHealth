...
import 'package:ihealth/pages/selectResultPageTwo.dart';
import 'package:ihealth/widgets/colors.dart';
import 'package:ihealth/widgets/font-style.dart';



class SelectResultPageOne extends StatefulWidget {
  const SelectResultPageOne({Key? key}) : super(key: key);

  @override
  _SelectResultPageOneState createState() => _SelectResultPageOneState();
}

class _SelectResultPageOneState extends State<SelectResultPageOne> {
        ...
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Text('1. Does T line appear?',
                  style: xLargeBlack,
                ),
              ),
